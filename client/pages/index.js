...
const HomepageHeading = ({ mobile }) => (
  <Container text>
    ...
    <Button
      ...
      size='huge'
      inverted
      style={{ backgroundColor: '#FF5733', color: '#fff' }} // Change button colors
    >
      ...
      <Media greaterThan='mobile'>
        ...
        >
          <Segment
            inverted
            textAlign='center'
            style={{ minHeight: 700, padding: '1em 0em', backgroundColor: '#222' }}
            vertical
          >
            <Menu size='large' inverted>
              <Link route='/'>
                  <a className='item' style={{ color: '#FF5733' }}>Home</a>
              </Link>

              <Menu.Menu position='right'>
                <Link route='/dashboard'>
                    <a className='item' style={{ color: '#FF5733' }}>Dashboard</a>
                </Link>

                <Link route='/list'>
                    <a className='item' style={{ color: '#FF5733' }}>Records List</a>
                </Link>
        ...
        <Sidebar.Pushable>
          ...
          <Sidebar.Pusher dimmed={sidebarOpened}>
            <Segment
              inverted
              textAlign='center'
              style={{ minHeight: 350, padding: '1em 0em', backgroundColor: '#222' }}
              vertical
            >
              <Container>
  ...
  <ResponsiveContainer>
    <Segment style={{ padding: '8em 0em' }} vertical>
      <Grid container stackable verticalAlign='middle'>
        <Grid.Row>
          <Grid.Column width={8}>
            <Header as='h3' style={{ fontSize: '2em', fontFamily: 'Arial, sans-serif' }}>
              We Help Companies and Companions
            </Header>
            <p style={{ fontSize: '1.33em', fontFamily: 'Arial, sans-serif' }}>
          ...
          <Grid.Column floated='right' width={6}>
            <Image
              ...
              rounded
              size='large'
              src='https://cdn.stocksnap.io/img-thumbs/960w/male-doctor_KN1OCKC4Y2.jpg' // Replace with your image URL
            />
          </Grid.Column>
        </Grid.Row>
        <Grid.Row>
      ...
      <Grid celled='internally' columns='equal' stackable>
        <Grid.Row textAlign='center'>
          <Grid.Column style={{ paddingBottom: '5em', paddingTop: '5em' }}>
            ...
            <p style={{ fontSize: '1.33em', fontFamily: 'Arial, sans-serif' }}>That is what they all say about us</p>
          </Grid.Column>
          <Grid.Column style={{ paddingBottom: '5em', paddingTop: '5em' }}>
            <Header as='h3' style={{ fontSize: '2em', fontFamily: 'Arial, sans-serif' }}>
    ...
    <Segment style={{ padding: '8em 0em' }} vertical>
      <Container text>
        ...
        <Button as='a' size='large' style={{ backgroundColor: '#FF5733', color: '#fff' }}>
          Read More
        </Button>
    ...
    <Segment inverted vertical style={{ padding: '5em 0em', backgroundColor: '#222' }}>
      <Container>
