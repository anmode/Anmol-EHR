...
export default class Dashboard extends PureComponent {
  ...
  static async getInitialProps() {
    ...
    const clinicCount = await record.methods.getClinicCount().call();
    const hospitalCount = await record.methods.getHospitalCount().call();
    ...
    return { patientCount, doctorCount, appointmentCount, permissionGrantedCount, data, pieData, patientMonthOverMonthChange, appointmentMonthOverMonthChange, patGrowthColor, apptGrowthColor, clinicCount,hospitalCount };
  }
    ...
    return (
      <Layout>
        <>
            ...
            <Card>
              <Card.Content>
                <Image
                  floated='right'
                  size='mini'
                  src='https://cdn-icons-png.flaticon.com/512/2914/2914307.png'
                />
                <Card.Header>Number of Clinics</Card.Header>
              </Card.Content>
              <Card.Content extra>
                <Statistic size='small'>
                  <Statistic.Value>{this.props.clinicCount}</Statistic.Value>
                </Statistic>
              </Card.Content>
            </Card>
            ...
            <Card>
              <Card.Content>
                <Image
                  floated='right'
                  size='mini'
                  src='https://cdn-icons-png.flaticon.com/512/2914/2914165.png'
                />
                <Card.Header>Number of Hospitals</Card.Header>
              </Card.Content>
              <Card.Content extra>
                <Statistic size='small'>
                  <Statistic.Value>{this.props.hospitalCount}</Statistic.Value>
                </Statistic>
              </Card.Content>
            </Card>
          ...
          <Segment padded>
            <h3 style={{ textAlign: "center" }}>Number of Patients vs Doctors in 2023</h3>
          ...
          <Segment padded>
            <h3 style={{ textAlign: "center" }}>Number of Appointments in 2023</h3>
            <ResponsiveContainer width="100%" aspect={3}>
              <LineChart
                width={500}
                height={300}
